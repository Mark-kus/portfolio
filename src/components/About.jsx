    ...
    return (
        ...
        md:min-h-0 md:flex-row'>
            ...
            <article className='text-center md: m-6'>
                ...
                applications. <br />
                I became a full stack web developer, graduated from <a href="https://www.soyhenry.com/" target='_blank' className='text-yellow-500'>SoyHenry</a>,
                and studied at <a href="https://www.udemy.com/" target='_blank' className='text-violet-500'>Udemy</a>, to later become self-taught. <br />
            </article>
        </article>
    )
}
...
const ProjectsAlert = ({ dictionary }) => {
    ...
    return (
        <button className="relative" onFocus={handleFocus} onBlur={handleBlur}>
            ...
            />
            <div
                className={`absolute bg-orange-400 dark:bg-yellow-300 p-2 -top-5 left-14 rounded-lg text-black z-10 sm:w-96 min-w-[19rem] transition-opacity ${
                    showPopover ? "opacity-100" : "opacity-0"
                }`}
            >
                {dictionary.alert}
